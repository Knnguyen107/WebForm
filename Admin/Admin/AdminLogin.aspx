...
<div class="jumbotron" style="border:1px solid #888;box-shadow:0px 2px 5px #ccc;">
                ...
                <table align="center" cellpadding="2" cellspacing="4" class="auto-style7">
                    <tr>
                    ...
                    <tr>
                        <td>Username:</td>
                        <td> <asp:TextBox ID="UserName" runat="server" Width="188px" /></td>
                    </tr>
                    <tr>
                        <td>Password:</td>
                        <td>  <asp:TextBox ID="Password" runat="server" Width="188px" /></td>
                    </tr>
                    <tr>
                        <td>&nbsp;</td>
                        <td>&nbsp;</td>
                    ...
                    <tr>
                        <td>&nbsp;</td>
                        <td><asp:Button ID="Login" runat="server"  Text="Log In" /></td>
                    </tr>
    </table>
